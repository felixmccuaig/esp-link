...
#FIRST -CHECK ALL DIRS EXIST, THEN COMPILE, THEN 
all: checkdirs $(TARGET_OUT) $(FW_FILE_1) $(FW_FILE_2)

#ELF TO IMAGE AND ACTUALLY CORRESPONDS TO FW_FILE_1 ECT JUST CONVERTS THE OBJ TO IMAGE AND SAVES IN FW DIR
...
$(TARGET_OUT): $(APP_AR)
	$(vecho) "LD $@"
	$(Q) $(LD) -L$(BUILD_AREA)/esp-open-lwip -L$(SDK_LIBDIR) $(LD_SCRIPT) $(LDFLAGS) -Wl,--start-group $(LIBS) $(APP_AR) -Wl,--end-group -o $@
...
#CREATE FW_BASE IF THERE IS NONE
$(FW_BASE):
	$(Q) mkdir -p $@
