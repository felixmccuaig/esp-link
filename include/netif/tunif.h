...
void tunif_set_ipaddr(struct tunif_data *data, uint32_t addr);
void tunif_set_netmask(struct tunif_data *data, uint32_t addr);
void tunif_set_gw(struct tunif_data *data, uint32_t addr);
...
void tunif_add_dns(uint32_t addr);
