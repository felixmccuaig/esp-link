...
tunif_ready(int fd, short events, void *ctx)
{
...
void
tunif_set_ipaddr(struct tunif_data *data, uint32_t addr)
{
	ip_addr_t ipaddr;
	ipaddr.addr = addr;
...
void
tunif_set_netmask(struct tunif_data *data, uint32_t addr)
{
	ip_addr_t ipaddr;
	ipaddr.addr = addr;
...
void
tunif_set_gw(struct tunif_data *data, uint32_t addr)
{
	ip_addr_t ipaddr;
	ipaddr.addr = addr;
